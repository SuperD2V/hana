...
const Section6 = () => {
  return (
    <div className='flex justify-between items-center !px-[120px] !py-[100px]'>
      {/* 왼쪽 영역: 교회 이름 변천사 */}
      <div className='flex flex-col items-center rounded-[20px] bg-[#FFFFFF] h-[396px] !p-[40px]'>
        <Typography
        ...
        >
          ...
          하나교회로, (본질 개척되면서) 하나교회가{"\n"}
          하나비전교회로 되었습니다. 조직에서 시작되었지만, 이름이 변화되면서
          '함께 하나님 나라를 바라본다'(하나비전)는 의미를 가지게 되었습니다.
          {"\n"}
          (원천하나비전교회는 줄여서 하나비전교회로 부릅니다.)
        </Typography>

        <div className='flex items-center gap-[12px] !mt-[40px] bg-[#F5F9FF] rounded-[12px] w-full !py-[20px] justify-center !mb-[20px]'>
          <Typography variant='title2Bold' className='!text-[#1B5FB8]'>
            1교회
          </Typography>
          <Image src={arrowImg} alt='arrow' className='w-[24px]' />
          <Typography variant='title2Bold' className='!text-[#1B5FB8]'>
            하나교회
          </Typography>
          <Image src={arrowImg} alt='arrow' className='w-[24px]' />
      ...
      <div className='flex flex-col items-center rounded-[20px] bg-[#FFFFFF] h-[396px] !p-[40px]'>
        ...
        >
          하나비전교회는 한국독립교회선교협의회(kaicam.org)에{"\n"}
          소속되어 있습니다. 이외 소속 교회로는{"\n"}
          원천안디옥교회(김정환 원로목사), 한빛두란노교회{"\n"}
          (김상복 원로목사), CCC(한국대학생선교회),{"\n"}
          베이직처치(조정민목사), 라이프하우스처치(홍민기목사){"\n"}
          등이 소속되어 있습니다.
        </Typography>
